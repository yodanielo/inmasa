...
?>
    ...
    ?>
        ...
        <p>
            <strong>INMASA</strong>, solicita su autorización para realizar el tratamiento de sus datos. No obstante, si usted no desea que el tratamiento mencionado anteriormente se produzca para usos no directamente relacionados con la gestión de posibles ofertas de empleo de INMASA, puede comunicárnoslo dirigiéndose a nosotros a través de los medios anteriormente indicados, marcando un "check" en la casilla que a continuación se detalla, significándole que, conforme a la legislación vigente, si no recibimos noticias suyas en el plazo de un mes, entenderemos otorgado su consentimiento que, en todo caso podría revocar en cualquier momento.
        </p>
        <p>
            <label>
                <input type="checkbox" name="desautorizo" value="1" />
